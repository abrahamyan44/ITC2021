...
import { Program, FitnessApp, ToDo, Accaunt, Food } from '../examples/index.js'
            ...
            <Card flat className='main-content'>
              ...
              >
                ...
                <Switch>
                    <Route
                      exact path="/"
                      component={() => <FitnessApp dark={dark} />}
                    />
                    <Route path="/program"
                      component={() => <Program dark={dark} />}
                    />
                    <Route path="/accaunt"
                      component={() => <Accaunt dark={dark}/> }
                    />
                    <Route path="/todo"
                      component={() => <ToDo dark={dark}/> }
                    />
                    <Route path="/food"
                      component={() => <Food dark={dark}/> }
                    />
                  </Switch>
                </Card>
