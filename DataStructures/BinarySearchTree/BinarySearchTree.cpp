...
template <class T>
void BinarySearchTree<T>::InsertRecursive(Node*& node, const T& data)
{
    if(node->data > data)
    {
        if(node->left) {
...
template <class T>
void BinarySearchTree<T>::Print(const std::string type, Node*& node)
{   
    if(type == "preorder")
    {
        if(node)
...
template <class T>
void BinarySearchTree<T>::TreeCopyRecursive(Node*& other_node, Node*& my_node)
{
...
template <class T>
void BinarySearchTree<T>::TreeDeleteRecursive(Node*& node)
{
    if(node)
    {
...
template <class T>
struct BinarySearchTree<T>::Node* BinarySearchTree<T>::FindDeletableNodesParentRecursive(Node*& node, const T& data)
{
...
template <class T>
T BinarySearchTree<T>::FindSubstituteNodeDataRecursive(Node*& parent_node, Node*& substitute_node)
{
...
template <class T>
void BinarySearchTree<T>::GetDeletableAndParentNodes(Node*& parent_node, Node*& deletable_node, const T& data)
{
    if(m_root->data != data)
    {
...
template <class T>
void BinarySearchTree<T>::GetAndReplaceSubstituteNode(Node*& parent_node, Node*& deletable_node)
{
...
template <class T>
void BinarySearchTree<T>::ReplaceSubstituteAndDeletableNodes(Node*& parent_node, Node*& deletable_node, Node*& substitute_node)
{
    if(parent_node)
    {
